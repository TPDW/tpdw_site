...
class DegreeTestCase(TestCase):
    def setUp(self):
        ...
        Degree.objects.create(title='BA', subject='PPE', thesis=thesis,
                              date_acquired='2010-01-01', university='Oxford',
                              grade='1st')
...
class FAQ_Question_AnswerTestCase(TestCase):
    def setUp(self):
        question = "What's up?"
        answer = "The sky."
        FAQ_Question_Answer.objects.create(Question=question,
                                           Answer=answer)
